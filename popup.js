document.addEventListener("DOMContentLoaded", function(e) {
    ...
    dictionary.addEventListener('click', updateOption);
    ...
    chrome.tabs.query({active: true}, function (tabs) {
        ...
        chrome.storage.local.get('options', function (items) {
            ...
            options = items.options || {dictionary: true, accentuation: true, abbreviations: true, capitalization: true};
            if (options.dictionary) dictionary.checked = true;
